...
urlpatterns = [
    ...
    path('opening_store', views.opening_store, name='opening_store'),
    path('opening_sponge', views.opening_sponge, name='opening_sponge'),
    path('opening_bms', views.opening_bms, name='opening_bms'),
    ...
    path('product_wise_mrp', views.product_wise_mrp, name='product_wise_mrp'),
    ...
    path('gantt/<str:line>/', views.gantt, name='gantt'),
]
