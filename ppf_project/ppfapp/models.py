...
class item_master(models.Model):
    ...
    l7 = models.CharField(max_length=100, unique=False,default=None)
    l7_qty = models.FloatField(max_length=50, unique=False,default=None)
    ...
    f7 = models.CharField(max_length=100, unique=False,default=None)
    f7_qty = models.FloatField(max_length=50, unique=False,default=None)
    ...
    d7 = models.CharField(max_length=100, unique=False,default=None)
    d7_qty = models.FloatField(max_length=50, unique=False,default=None)
...
class gantt_item_master(models.Model):
...
class production_done(models.Model):
    itemcode=models.CharField(max_length=100)
    itemname=models.CharField(max_length=100,default=None)
    qty=models.IntegerField()
    station_no=models.CharField(max_length=100,default=None)


class gantt_comman_line(models.Model):
    itemcode=models.CharField(max_length=100)
    itemname=models.CharField(max_length=100)
    ...
    stn_line = models.CharField(max_length=100,default=None)
    date=models.DateField()

    class Meta:
        abstract=True

class gantt_line1(gantt_comman_line):
    pass
class gantt_line_status(models.Model):
    itemcode=models.CharField(max_length=100)
    itemname=models.CharField(max_length=100)
    starttime=models.TimeField()
    endtime=models.TimeField()
...
class gantt_lines(models.Model):
